DROP DATABASE IF EXISTS `wso2ei`;
CREATE DATABASE `wso2ei`;
USE `wso2ei`;
...
INSERT INTO IDN_BASE_TABLE values ('WSO2 Enterprise Integration');
...
DROP DATABASE IF EXISTS wso2eianalytics;
CREATE DATABASE wso2amanalytics;
