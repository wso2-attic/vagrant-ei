# @Author: ching
# @Date:   2018-01-23T18:06:22+05:30
# @Last modified by:   ching
# @Last modified time: 2018-01-23T18:51:43+05:30
...
mysql -u${DB_USER} -p${DB_PASSWORD} -e "source /vagrant/mysql/provisioner/scripts/mysql.sql"
